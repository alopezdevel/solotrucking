...
<!--- HEADER----->
<div class="header section-services">
	<h1 class="wow animated fadeInLeft delay-02s">Our Products</h1>
	<h3 class="wow animated fadeInRight delay-03s">Wide range of capabilities to serve our Clients.</h3>
</div>
<!--- TERMINA HEADER----->
<section class="main-section home-section-a"><!--main-section-start-->
	<div class="container">
    	<h2>Commercial Truck Insurance</h2>
    	<h6>We offer the following insurance products.</h6>
    	<div class="portfolioContainer wow fadeInUp delay-04s">
                <div class="Portfolio-box webdesign">
                    <a href="#"><img src="images/cont/img-services-al.jpg" alt=""></a>    
                    <h3>AL Insurance</h3>
                    <p>Auto  Liability </p>
                </div>
                <div class=" Portfolio-box branding">
                    <a href="#"><img src="images/cont/img-services-mtc.jpg" alt=""></a>    
                    <h3>MTC Insurance</h3>
                    <p>Motor Truck Cargo</p>
                </div>
                <div class=" Portfolio-box photography" >
                    <a href="#"><img src="images/cont/img-services-pd.jpg" alt=""></a>    
                    <h3>PD Insurance</h3>
                    <p>Physical Damage </p>
                </div>
                <div class=" Portfolio-box branding">
                    <a href="#"><img src="images/cont/img-services-tic.jpg" alt=""></a>    
                    <h3>TI Insurance</h3>
                    <p>Trailer Interchange</p>
                </div>
                <div class=" Portfolio-box photography">
                    <a href="#"><img src="images/cont/img-services-b.jpg" alt=""></a>    
                    <h3>Bobtail Insurance</h3>
                    <p>Bobtail</p>
                </div>
                <div class=" Portfolio-box photography">
                    <a href="#"><img src="images/cont/img-services-wc.jpg" alt=""></a>    
                    <h3>WC Insurance</h3>
                    <p>Workers Compensation</p>
                </div>
                <div class=" Portfolio-box photography">
                    <a href="#"><img src="images/cont/img-services-u.jpg" alt=""></a>    
                    <h3>Umbrella Insurance</h3>
                    <p>Umbrella</p>
                </div>
                <div class=" Portfolio-box photography">
                    <a href="#"><img src="images/cont/img-services-gl.jpg" alt=""></a>    
                    <h3>GL Insurance</h3>
...
<footer class="footer">
    <div class="container">
    	 <div class="nav_foot">
    	 	...
    	 	<a href="system/login" style="display: none;">Claims</a>     
