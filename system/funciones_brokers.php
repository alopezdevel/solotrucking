<?php
  ...
  function get_brokers(){
    ...
    //contando registros // 
    $query_rows = "SELECT COUNT(iConsecutivo) AS total FROM ct_brokers ".$filtroQuery;
    ...
    if($registros == "0"){
        ...
        $sql = "SELECT iConsecutivo, sName, sTelefono, sNombreContacto, sEmail FROM ct_brokers ".$filtroQuery.$ordenQuery." LIMIT ".$limite_inferior.",".$limite_superior; 
  ...
  function get_broker(){
      ...
      include("cn_usuarios.php");
      $conexion->autocommit(FALSE);                                                                                                                 
      $sql = "SELECT iConsecutivo, sName, sTelefono, sNombreContacto, sEmail FROM ct_brokers WHERE iConsecutivo = '".$clave."'";
      $result = $conexion->query($sql);
  ...
  function save_broker(){
      ...
      $_POST['sEmail'] = strtolower($_POST['sEmail']); 
      ...
      $query = "SELECT COUNT(iConsecutivo) AS total FROM ct_brokers WHERE sName ='".$_POST['sName']."'";
      ...
      if($error == '0'){
          if($_POST["edit_mode"] == 'true'){
            ...
            $sql = "UPDATE ct_brokers SET ".implode(",",$valores)." WHERE iConsecutivo ='".$_POST['iConsecutivo']."'";
            ...
            $sql = "INSERT INTO ct_brokers (".implode(",",$campos).") VALUES ('".implode("','",$valores)."')";
  ...
  function delete_broker(){
      ...
      $query = "DELETE FROM ct_brokers WHERE iConsecutivo = '".$_POST["clave"]."'"; 
