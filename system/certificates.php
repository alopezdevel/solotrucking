        ...
        <form>
            <fieldset>
                ...
                <div class="field_item">
                    <label>E-mail to send *:</label>
                    <input id="email"  type="text" maxlength="55" class="txt-lowercase" style="width: 99%;">
                </div>
                <div class="field_item">
                    <label>Message:</label>
                    <textarea id="sDescription" maxlength="1000" style="width: 99%;"></textarea>
                </div>
                <legend>Certificate Cholder</legend>
                <div class="field_item cholder">
                    <label>Company Name *:</label> 
                    <input id="sCholderA"  type="text" class="txt-uppercase" style="width: 99%;">
                </div>
                <div class="field_item cholder">
                    <label>Address *:</label> 
                    <input id="sCholderB"  type="text" class="txt-uppercase" style="width: 99%;">
                </div>
                <div class="field_item cholder">
                    <label>State *:</label> 
                    <input id="sCholderC"  type="text" class="txt-uppercase" style="width: 99%;">
                </div>
                <div class="field_item cholder">
                    <label>City *:</label> 
                    <input id="sCholderD"  type="text" class="txt-uppercase" style="width: 99%;">
                </div>
                <div class="field_item cholder">
                    <label>Zip Code *:</label> 
                    <input id="sCholderE"  type="text" class="txt-uppercase" style="width: 99%;">
                </div>
            </fieldset>
            <br>
