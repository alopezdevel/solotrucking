            ...
            <table style="width:100%;" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <div class="field_item">
                        ...
                        <input tabindex="1" class="txt-uppercase" id="sName" name="sName" type="text" placeholder="" maxlength="255" style="width: 99%;"> 
                    </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <div class="field_item">
                        ...
                        <input class="txt-lowercase" tabindex="2" id="sEmail" name="sEmail" type="text" placeholder="" maxlength="255" style="width: 99%;" title="If you have more of one emails to send, please separate it by ','.">
                    </div> 
                    </td>
                </tr>
                <tr>
                    <td><div class="field_item"> <label>Phone Number: </label><input id="sTelefono" name="sTelefono" type="text" class="num" style="width: 97%;"></div></td>
                    <td><div class="field_item"> <label>Contact Name(s): </label><input id="sNombreContacto" name="sNombreContacto" type="text" class="txt-uppercase"></div></td>
                </tr>
            </table>
