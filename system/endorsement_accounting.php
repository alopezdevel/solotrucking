...
<?php include("header.php"); ?>   
    ...
    var fn_invoices = {
            ...
            fillgrid: function(){
                   $.ajax({             
                    type:"POST", 
                    url:"endorsement_accounting_server.php", 
                    data:{
                        accion:"get_list",
            ...
            edit : function (){
                $(fn_invoices.data_grid + " tbody td .edit").bind("click",function(){
                    ...
                    $.post("endorsement_accounting_server.php",
            ...
            save : function (){
               ...
               if(valid){
                 if($(fn_invoices.form+' input[name=iConsecutivo]').val() != ''){struct_data_post.edit_mode = "true";}else{struct_data_post.edit_mode = "false";}  
                    ...
                    $.post("endorsement_accounting_server.php",struct_data_post.parse(),
                    function(data){
                        switch(data.error){
                         case '0':
