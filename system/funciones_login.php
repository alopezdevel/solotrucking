<?php
   ...
   function  conexion(){                
      ...
      $queryUsuario = "SELECT iConsecutivoTipoUsuario, sUsuario, hActivado ".  
                      "FROM cu_control_acceso WHERE sCorreo = '".$usuario."' AND hClave = '".$clave."'"; 
      ...
      if($rows > 0 ){
            ...
            //validando query de acceso a compañias // tipo de usuario --> 2
              if($tipo_usuario['iConsecutivoTipoUsuario'] == '2'){
                 ...
                 $rows2 = $result->num_rows; 
                 if($rows2 > 0){
                    //$user = $result->fetch_array(); //Array data.
                    $respuesta = '1';   
                 }else{
                     $respuesta = '2';
