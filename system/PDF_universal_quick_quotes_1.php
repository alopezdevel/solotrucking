<?php
  ...
  if($_GET['coverages_auto_liability'] != ""){
      switch($_GET['coverages_auto_liability']){
          ...
          CASE "other" : 
            $COVERAGES_OTHER = "X";
            $COVERAGES_OTHER_LABEL = $_GET['auto_liability_other'];  
          break;
          default  : "" ; break;
 ...
 // $DMV = "DMV";  
  ...
  //---------------------------------------------------------CAMPOS-----------------------------------------------------
    //---------------------------------------------------------HEAD-----------------------------------------------------
        ...
        //OTHER COVERAGES:
        $other_coverage1 = $_GET['other_coverage1'];
        $other_coverage2 = $_GET['other_coverage2'];
        $other_coverage3 = $_GET['other_coverage3'];
        $other_coverage4 = $_GET['other_coverage4'];
        
        $x = 18;             
        $y = 214;
        $pdf->SetXY($x,$y);
        $pdf->Write(5,$other_coverage1);
        
        $x = 54;             
        $y = 214;
        $pdf->SetXY($x,$y);
        $pdf->Write(5,$other_coverage2);
        
        $x = 90;             
        $y = 214;
        $pdf->SetXY($x,$y);
        $pdf->Write(5,$other_coverage3);
        
        $x = 153;             
        $y = 214;
        $pdf->SetXY($x,$y);
        $pdf->Write(5,$other_coverage4);
        ...
        if(count($arr_trailer)>0 || count($arr_drivers)>0 || count($arr_equipment)>0){
            ...
            if(count($arr_drivers)>0){  
                ...
                if(count($arr_drivers)>0){
                    ...
                    foreach($arr_drivers as $driver){
                        ...
                        $x += 98;
                        $pdf->SetXY($x, $y);
                        $pdf->Cell(27,5,$driver["fecha_nacimiento"],1,0,'C',0);
                        $x += 27;
                        $pdf->SetXY($x, $y);
            ...
            if(count($arr_equipment)>0){
                ...
                foreach($arr_equipment as $equipment){
                    ...
                    $x += 25;
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(25,5,$equipment["peso"],1,0,'L',0);
                    $x += 25;
                    $pdf->SetXY($x, $y);
                    ...
                    $x += 30;
                    $pdf->SetXY($x, $y);
                    $equipment["deductible"] != "" ? $deductible  = '$ '.number_format($equipment["deductible"]) : $deductible = "";  
                    $pdf->Cell(30,5,$deductible,1,0,'R',0);
                    $y += 5;
            ...
            if(count($arr_trailer)>0){
                ...
                foreach($arr_trailer as $trailer){
                    ...
                    $x += 25;
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(25,5,$trailer["peso"],1,0,'L',0);
                    $x += 25;
                    $pdf->SetXY($x, $y);
                    $trailer["stated_value"] != "" ? $stated_value  = '$ '.number_format($trailer["stated_value"]) : $stated_value = "";
                    $pdf->Cell(30,5,$stated_value,1,0,'R',0);
                    $x += 30;
                    $pdf->SetXY($x, $y);
                    $trailer["deductible"] != "" ?  $deductible = '$ '.number_format($trailer["deductible"]) : $deductible = "";
                    $pdf->Cell(30,5,$deductible,1,0,'R',0);
                    $y += 5;
