...
<nav class="main-nav-outer" id="test"><!--main-nav-start-->
	<div class="container">
		...
		<ul class="top-nav">
			<li><a href="system/login" class="login-btn" title="Log In"><span>My Account</span></a></li>
...
<div id="slider-container">
	<div class="cont">
		<div class="frm_quote">
			<h3>My Account</h3>
			<a href="system/login" class="btn_4"><span>LOGIN</span></a>
	...
	<div class="container">
    	...
    	<div class="col-md-3 wow fadeInUp delay-02s">
    		<div class="bann">
    			...
    			<h3>About Us</h3>
    			<p>SoloTrucking was founded in 2010 by Juan C. Sanchez, who believes the agency to provide insurance products to all carriers of Texas...</p>
    	...
    	<div class="col-md-3 wow fadeInUp delay-04s">
    		...
    		<div class="bann">
    			...
    			<a href="faq" class="btn_1"><span>Read more</span></a>
    		</div>
    	</div>

	</div>
</section><!--main-section-end-->
<section class="main-section home-section-b" style="display: none;"><!--main-section-start-->
	<div class="container">
